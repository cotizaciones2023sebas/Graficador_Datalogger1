[requirements.txt](https://github.com/user-attachments/files/28223555/requirements.txt)
# Graficador_Datalogger1
Aplicación profesional para análisis eléctrico industrial
[index.py](https://github.com/user-attachments/files/28223556/index.py)
